...
public class DockerAssignment {
	...
	public ModelAndView playlistHtml(){
	...
	public String playlist() {
		...
		try {
			...
			for(int i = 0; i < songsArray.length(); i++){
				...
				playlistSpot = songItem.getInt("playlistSpot");
				albumName = songItem.getString("album");
				songTitle = songItem.getString("songTitle");


				info += " \u001B" + " \u001B" + "#" + playlistSpot + " " + artist  + "  song: " + songTitle + " from the album: " + albumName;
	...
	public static void main(String[] args) {
		SpringApplication.run(DockerAssignment.class, args);
	}
